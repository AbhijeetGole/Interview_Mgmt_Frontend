      ...
      >
        <Box sx={style}>
          ...
          <CardContent>
            ...
            <span style={{ fontWeight: "bold" }}> FirstName: </span>{panel.firstName}
            </Typography>
            <Typography sx={{ mb: 1 }} color="text.secondary" gutterBottom>
            <span style={{ fontWeight: "bold" }}> LastName: </span>{panel.lastName}
            </Typography>
            <Typography sx={{ mb: 1 }} color="text.secondary">
            <span style={{ fontWeight: "bold" }}> Skills: </span>{panel.skills + " "}
            </Typography>

            <Typography sx={{ mb: 1 }} color="text.secondary">
            <span style={{ fontWeight: "bold" }}> Experience: </span>{panel.experience}
            </Typography>
            <Typography sx={{ mb: 1 }} color="text.secondary">
            <span style={{ fontWeight: "bold" }}>Location:</span> {panel.location}
            </Typography>
            <Typography sx={{ mb: 1 }} color="text.secondary">
            <span style={{ fontWeight: "bold" }}> Designation:</span> {panel.role}
            </Typography>
            <Typography color="text.secondary">
            <span style={{ fontWeight: "bold" }}>Phone No:</span> {panel.phone}
            </Typography>
          </CardContent>
          <CardActions>
            <Button
